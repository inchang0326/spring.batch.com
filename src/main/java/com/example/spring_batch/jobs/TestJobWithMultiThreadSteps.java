...
@Slf4j
@Configuration
public class TestJobWithMultiThreadSteps { // MultiThread Steps
    ...
    @Bean("TESTJOB01_myBatisPagingItemReader")
    @StepScope
    ...
    @Bean("TESTJOB01_myBatisBatchItemWriter")
    @StepScope
